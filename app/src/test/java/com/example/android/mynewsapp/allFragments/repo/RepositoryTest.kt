...
import com.example.android.mynewsapp.FakeDataSourceInterface
...
class RepositoryTest{
    ...
    private lateinit var remoteDataSource: FakeDataSourceInterface
    private lateinit var localDataSource: FakeDataSourceInterface
    ...
    fun createRepo(){
        ...
        remoteDataSource = FakeDataSourceInterface(remoteData.toMutableList())
        localDataSource = FakeDataSourceInterface(localData.toMutableList())
    ...
    fun setDataFromNetwork_updateLocalData()= mainCoroutineRule.runBlockingTest {
       ...
       repositoryToTest.setDataFromNetwork()
        val allArticles = FakeDataSourceInterface.getLiveDataAddedToRemoteSource(remoteDataSource).getOrAwaitValue2()
